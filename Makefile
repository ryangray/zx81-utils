...
p2t-test0: test/hitch-hiker.bas
...
hex2rem-test1: test/hex2rem.bas test/hex2rem.p
...
rem2bin-test: test/rem2bin.bin test/rem2bin.txt
...
pictest.tap: test/pic.tap loadpic.tap
